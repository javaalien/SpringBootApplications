...
@Configuration
@EnableJpaRepositories(basePackages = "com.alien.orders.repositories", entityManagerFactoryRef = "ordersEntityManagerFactory", transactionManagerRef = "ordersTransactionManager")
...
public class OrdersDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean ordersEntityManagerFactory() {
		...
		factory.setPackagesToScan(new String[] { "com.alien.orders.entities" });
