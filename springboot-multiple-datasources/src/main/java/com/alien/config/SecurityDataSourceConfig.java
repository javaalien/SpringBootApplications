...
@Configuration
@EnableJpaRepositories(basePackages = "com.alien.security.repositories", entityManagerFactoryRef = "securityEntityManagerFactory", transactionManagerRef = "securityTransactionManager")
public class SecurityDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean securityEntityManagerFactory() {
		...
		factory.setPackagesToScan(new String[] { "com.alien.security.entities" });
